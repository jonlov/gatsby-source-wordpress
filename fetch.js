...
var getPages = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(_ref8) {
    ...
    var result, getOptions, options, _ref10, headers, data, wpTotal, total, totalPages, requests;
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            getOptions = function getOptions(page) {
              ...
              var o = {
                method: `get`,
                url: `${url}?${querystring.stringify(stringifyOpts)}`
              };
              if (_hostingWPCOM) {
                o.headers = {
...
var httpExceptionHandler = require(`./http-exception-handler`);function getValidRoutes(_ref11) {
